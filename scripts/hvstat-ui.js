...
function saveSettings() {
	...
	hvStat.settings.isShowCumEndStats = $("input[name=isShowCumEndStats]").get(0).checked;
	hvStat.settings.isShowCumEndProfs = $("input[name=isShowCumEndProfs]").get(0).checked; //isShowEndProfs added by Ilirith
	hvStat.settings.isShowCumEndProfsMagic = $("input[name=isShowCumEndProfsMagic]").get(0).checked; //isShowEndProfs added by Ilirith
	hvStat.settings.isShowCumEndProfsArmor = $("input[name=isShowCumEndProfsArmor]").get(0).checked; //isShowEndProfs added by Ilirith
	hvStat.settings.isShowCumEndProfsWeapon = $("input[name=isShowCumEndProfsWeapon]").get(0).checked; //isShowEndProfs added by Ilirith
